...
public final class SQLiteConnection
{
    ...
    private static native long nativeOpen(String path, int openFlags,
            String username, String deviceId, String label,
    ...
    private static native void nativeRegisterLocalizedCollators(
            long connectionPtr, String locale);

    private static native long nativePrepareStatement(long connectionPtr,
            String sql);
    ...
    private static native int nativeGetColumnCount(long connectionPtr,
    		long statementPtr);

    private static native String nativeGetColumnName(long connectionPtr,
    		long statementPtr, int index);

    private static native void nativeBindNull(long connectionPtr,
    		long statementPtr, int index);

    private static native void nativeBindLong(long connectionPtr,
    		long statementPtr, int index, long value);

    private static native void nativeBindDouble(long connectionPtr,
    		long statementPtr, int index, double value);

    private static native void nativeBindString(long connectionPtr,
    		long statementPtr, int index, String value);

    private static native void nativeBindBlob(long connectionPtr,
    		long statementPtr, int index, byte[] value);
    ...
    //            long connectionPtr, int statementPtr);
    private static native int nativeExecuteForChangedRowCount(
            long connectionPtr, long statementPtr);
    ...
    private static native long nativeExecuteForCursorWindow(long connectionPtr,
    		long statementPtr, long windowPtr, int startPos, int requiredPos,
    ...
    private SQLiteConnection(SQLiteConnectionPool pool,
            SQLiteDatabaseConfiguration configuration, int connectionId,
    ...
    private void open()
    {
        ...
        mConnectionPtr = nativeOpen(mConfiguration.path,
                mConfiguration.openFlags, mConfiguration.username, deviceId,
                mConfiguration.label, SQLiteDebug.DEBUG_SQL_STATEMENTS,
    ...
    private void dispose(boolean finalized)
    {
        ...
        if (mConnectionPtr != 0)
        {
            final int cookie = mRecentOperations.beginOperation("close", null,
                    null);
            try
            {
    ...
    private void setForeignKeyModeFromConfiguration()
    {
        ...
        {
            final long newValue = mConfiguration.foreignKeyConstraintsEnabled ? 1
                    : 0;
    ...
    private void setJournalMode(String newValue)
    {
        ...
        if (!value.equalsIgnoreCase(newValue))
        {
            try
            {
                String result = executeForString("PRAGMA journal_mode="
                        + newValue, null);
    ...
    private void setLocaleFromConfiguration()
    {
        ...
        try
        {
            ...
            final String oldLocale = executeForString(
                    "SELECT locale FROM android_metadata "
                            + "UNION SELECT NULL ORDER BY locale DESC LIMIT 1",
                    null);
        ...
        {
            throw new SQLiteException("Failed to change locale for db '"
                    + mConfiguration.label + "' to '" + newLocale + "'.");
        }
    }
    ...
    void reconfigure(SQLiteDatabaseConfiguration configuration)
    {
        ...
        for (int i = 0; i < functionCount; i++)
        {
            SQLiteCustomFunction function = configuration.customFunctions
                    .get(i);
        ...
        boolean localeChanged = !configuration.locale
                .equals(mConfiguration.locale);
        ...
        try
        {
            method = mPreparedStatementCache.getClass().getMethod("resize",
                    new Class[]
                    { int.class });
            method.invoke(mPreparedStatementCache, new Object[]
            { configuration.maxSqlCacheSize });
        }
    ...
    public void prepare(String sql, SQLiteStatementInfo outStatementInfo)
    {
        ...
        final int cookie = mRecentOperations.beginOperation("prepare", sql,
                null);
        try
        {
                                                     ...
                                                     CancellationSignal cancellationSignal*/)
    {
        ...
        final int cookie = mRecentOperations.beginOperation("execute", sql,
                bindArgs);
        try
        {
            final PreparedStatement statement = acquirePreparedStatement(sql);
    ...
    public long executeForLong(String sql, Object[] bindArgs)
    {
        ...
        final int cookie = mRecentOperations.beginOperation("executeForLong",
                sql, bindArgs);
        try
        {
            final PreparedStatement statement = acquirePreparedStatement(sql);
            try
            {
                ...
                try
                {
                    return nativeExecuteForLong(mConnectionPtr,
                                                                ...
                                                                CancellationSignal cancellationSignal*/)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                try
                {
                    return nativeExecuteForString(mConnectionPtr,
                            statement.mStatementPtr);
                }
                finally
                {
    ...
    public int executeForChangedRowCount(String sql, Object[] bindArgs)
    {
        ...
        finally
        {
            ...
            {
                mRecentOperations.logOperation(cookie, "changedRows="
                        + changedRows);
            }
        }
    }
    ...
    public long executeForLastInsertedRowId(String sql, Object[] bindArgs)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                try
                {
                    return nativeExecuteForLastInsertedRowId(mConnectionPtr,
                            statement.mStatementPtr);
                }
                finally
                {
            ...
            boolean countAllRows)
    {
        ...
        try
        {
            ...
            int filledRows = -1;
            final int cookie = mRecentOperations.beginOperation(
                    "executeForCursorWindow", sql, bindArgs);
            try
            {
                final PreparedStatement statement = acquirePreparedStatement(sql);
                try
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            Field field = window.getClass().getField(
                                    "mWindowPtr");
                            windowPtr = (Long) field.get(window);
                        }
                        catch (Exception e)
                        {
                            // TODO Auto-generated catch block
                        ...
                        final long result = nativeExecuteForCursorWindow(
                                mConnectionPtr, statement.mStatementPtr,
                                windowPtr, startPos, requiredPos, countAllRows);
            ...
            finally
            {
                if (mRecentOperations.endOperationDeferLog(cookie))
                {
                    mRecentOperations.logOperation(cookie, "window='" + window
                            + "', startPos=" + startPos + ", actualPos="
                            + actualPos + ", filledRows=" + filledRows
    ...
    private PreparedStatement acquirePreparedStatement(String sql)
    {
        ...
        try
        {
            final int numParameters = nativeGetParameterCount(mConnectionPtr,
                    statementPtr);
            final int type = DatabaseUtils.getSqlStatementType(sql);
            final boolean readOnly = nativeIsReadOnly(mConnectionPtr,
                    statementPtr);
            statement = obtainPreparedStatement(sql, statementPtr,
                    numParameters, type, readOnly);
    ...
    private void releasePreparedStatement(PreparedStatement statement)
    {
        ...
        if (statement.mInCache)
        {
            try
            {
                nativeResetStatementAndClearBindings(mConnectionPtr,
                        statement.mStatementPtr);
            }
            catch (SQLiteException ex)
            {
    ...
    private void bindArguments(PreparedStatement statement, Object[] bindArgs)
    {
        ...
        {
            throw new SQLiteBindOrColumnIndexOutOfRangeException("Expected "
                    + statement.mNumParameters + " bind arguments but " + count
                    + " were provided.");
        }
        if (count == 0)
        {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            {
                case DatabaseUtils.FIELD_TYPE_NULL:
                    nativeBindNull(mConnectionPtr, statementPtr, i + 1);
                    break;
                case DatabaseUtils.FIELD_TYPE_INTEGER:
                    nativeBindLong(mConnectionPtr, statementPtr, i + 1,
                            ((Number) arg).longValue());
                    break;
                case DatabaseUtils.FIELD_TYPE_FLOAT:
                    nativeBindDouble(mConnectionPtr, statementPtr, i + 1,
                            ((Number) arg).doubleValue());
                    break;
                case DatabaseUtils.FIELD_TYPE_BLOB:
                    nativeBindBlob(mConnectionPtr, statementPtr, i + 1,
                            (byte[]) arg);
                    break;
                case DatabaseUtils.FIELD_TYPE_STRING:
                default:
    ...
    void dumpUnsafe(Printer printer, boolean verbose)
    {
        ...
        if (verbose)
        {
            printer.println("  connectionPtr: 0x"
                    + Long.toHexString(mConnectionPtr));
        }
        printer.println("  isPrimaryConnection: " + mIsPrimaryConnection);
        printer.println("  onlyAllowReadOnlyOperations: "
    ...
    void collectDbStats(ArrayList<DbStats> dbStatsList)
    {
        ...
        try
        {
            executeForCursorWindow("PRAGMA database_list;", null, window, 0, 0,
                    false);
            for (int i = 1; i < window.getNumRows(); i++)
            {
                ...
                try
                {
                    pageCount = executeForLong("PRAGMA " + name
                            + ".page_count;", null);
                ...
                dbStatsList.add(new DbStats(label, pageCount, pageSize, 0, 0,
                        0, 0));
            }
        }
        catch (SQLiteException ex)
    ...
    private DbStats getMainDbStatsUnsafe(int lookaside, long pageCount,
            long pageSize)
    {
    ...
    {
        return "SQLiteConnection: " + mConfiguration.path + " ("
                + mConnectionId + ")";
    }

    private PreparedStatement obtainPreparedStatement(String sql,
            long statementPtr, int numParameters, int type, boolean readOnly)
    {
    ...
    private final class PreparedStatementCache extends
            LruCache<String, PreparedStatement>
    {
        ...
        public void dump(Printer printer)
        {
            ...
            {
                int i = 0;
                for (Map.Entry<String, PreparedStatement> entry : cache
                        .entrySet())
                {
    ...
    private static final class OperationLog
    {
        ...
        private boolean endOperationDeferLogLocked(int cookie)
        {
            ...
            if (operation != null)
            {
                ...
                return SQLiteDebug.DEBUG_LOG_SLOW_QUERIES
                        && SQLiteDebug.shouldLogSlowQuery(operation.mEndTime
                                - operation.mStartTime);
            }
            return false;
        }
    ...
    private static final class Operation
    {
        ...
        public void describe(StringBuilder msg, boolean verbose)
        {
            ...
            {
                msg.append(" started ")
                        .append(System.currentTimeMillis() - mStartTime)
                        .append("ms ago");
            }
            msg.append(" - ").append(getStatus());
            if (mSql != null)
            {
                msg.append(", sql=\"").append(trimSqlForDisplay(mSql))
                        .append("\"");
            }
            ...
            if (mException != null)
            {
                msg.append(", exception=\"").append(mException.getMessage())
                        .append("\"");
            }
        }
