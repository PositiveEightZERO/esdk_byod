...
public class CursorWindow extends SQLiteClosable implements Parcelable {
    ...
    public boolean isNull(int row, int column) {
        return getType(row, column) == DatabaseUtils.FIELD_TYPE_NULL;
    }
    ...
    public boolean isBlob(int row, int column) {
        ...
        return type == DatabaseUtils.FIELD_TYPE_BLOB || type == DatabaseUtils.FIELD_TYPE_NULL;
    }
    ...
    public boolean isLong(int row, int column) {
        return getType(row, column) == DatabaseUtils.FIELD_TYPE_INTEGER;
    }
    ...
    public boolean isFloat(int row, int column) {
        return getType(row, column) == DatabaseUtils.FIELD_TYPE_FLOAT;
    }
    ...
    public boolean isString(int row, int column) {
        int type = getType(row, column);
        return type == DatabaseUtils.FIELD_TYPE_STRING || type == DatabaseUtils.FIELD_TYPE_NULL;
    }
