...
public class SvnHttpsSocketFactory implements LayeredSocketFactory {
        ...
        throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
        ...
        this.sslcontext.engineInit(keymanagers, trustmanagers, random);
    ...
    public SvnHttpsSocketFactory(final KeyStore keystore, final String keystorePassword) 
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
        this(TLS, keystore, keystorePassword, null, null, null);
    }

    public SvnHttpsSocketFactory(final KeyStore truststore) 
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
     ...
     * @hide
     */
    public SvnHttpsSocketFactory(javax.net.ssl.SSLSocketFactory socketfactory) {
        super();
...
//        }
        ...
        remoteAddress = new InetSocketAddress(SvnSocket.getHostbyName(host), port); 
