...
static jlong nativeOpen(JNIEnv* env, jclass clazz, jstring pathStr, jint openFlags, jstring usernameStr, jstring deviceIdStr,
    ...
    const char* usernameChars = env->GetStringUTFChars(usernameStr, NULL);
    String8 username(usernameChars);
    env->ReleaseStringUTFChars(usernameStr, usernameChars);

    const char* deviceIdChars = env->GetStringUTFChars(deviceIdStr, NULL);
    String8 deviceId(deviceIdChars);
    env->ReleaseStringUTFChars(deviceIdStr, deviceIdChars);
    ...
    sqlite3* db;
    int err = sqlite3_open_s(path.string(), &db, sqliteFlags, NULL, username.string(), deviceId.string());

    //int err = sqlite3_open_s(path.string(), &db, sqliteFlags, NULL, "sdk", "cf1b66eff4c46feb");
    if (err != SQLITE_OK) {
...
static JNINativeMethod sMethods[] =
{
    ...
    { "nativeOpen", "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZ)J",
            (void*)nativeOpen },
    { "nativeClose", "(J)V",
            (void*)nativeClose },
    { "nativeRegisterCustomFunction", "(JLcom/huawei/svn/sdk/sqlite/SQLiteCustomFunction;)V",
...
int register_svn_sqlite_SQLiteConnection(JNIEnv *env)
{
    jclass clazz = FindClassOrDie(env, "com/huawei/svn/sdk/sqlite/SQLiteCustomFunction");
    ...
    return RegisterMethodsOrDie(env, "com/huawei/svn/sdk/sqlite/SQLiteConnection", sMethods,
                                NELEM(sMethods));
}
