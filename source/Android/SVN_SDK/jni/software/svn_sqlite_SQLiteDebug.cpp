...
{
    { "nativeGetPagerStats", "(Lcom/huawei/svn/sdk/sqlite/SQLiteDebug$PagerStats;)V",
            (void*) nativeGetPagerStats },
};

int register_svn_sqlite_SQLiteDebug(JNIEnv *env)
{
    jclass clazz = FindClassOrDie(env, "com/huawei/svn/sdk/sqlite/SQLiteDebug$PagerStats");
    ...
    return RegisterMethodsOrDie(env, "com/huawei/svn/sdk/sqlite/SQLiteDebug",
