...
static void sqliteInitialize() {
    ...
    sqlite3_config(SQLITE_CONFIG_LOG, &sqliteLogCallback, false ? (void*)1 : NULL);
...
int register_svn_sqlite_SQLiteGlobal(JNIEnv *env)
{
    sqliteInitialize();

    return RegisterMethodsOrDie(env, "com/huawei/svn/sdk/sqlite/SQLiteGlobal",
